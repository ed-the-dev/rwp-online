var elements = document.getElementsByClassName("show-on-scroll");

// the html hasn't been read yet, so call this script after html?
...
function scrolling() {
  ...
  // check here that the element is being accessed.
